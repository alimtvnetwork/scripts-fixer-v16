...
#  Usage:  curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/scripts-fixer-v15/main/install.sh | bash
#
...
FALLBACK_SLUG="scripts-fixer-v15"
...
# Args: <repo-vN-name>   (e.g. scripts-fixer-v15)
